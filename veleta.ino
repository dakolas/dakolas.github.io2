...
const int rs = 34, en = 33, d4 = 24, d5 = 26, d6 = 28, d7 = 30; 
...
BME280 bme280; // Create an instance of the barometric pressure sensor
DHT dht(DHTPIN, DHTTYPE); // Create an instance of the temp/humidity DHT22 sensor
MQ135 gasSensor = MQ135(A8); // Create an instance of the CO2 sensor
...
void writeInLCD() {
  ...
  if(millis() - lcd_timer >= 1000) {
    ...
    if (screen == 2) {
      ...
      lcd.setCursor(0,0);
      lcd.print("Vel viento: ");
      lcd.print(windspeedmph);
      lcd.print(" mph"); // 
      
      lcd.setCursor(0,1);
      lcd.print("Dir viento: ");
      lcd.print(winddir);
      lcd.print(" 337");
...
void setup()
{
    ...
    pinMode(A8, INPUT); // Analog input for the CO2 sensor
    ...
    if(!bme280.init()){
      Serial.println("Barometric pressure device error!");
    }
...
void printWeather()
{
    ...
    Serial.println(windspeedmph*1,60934);
